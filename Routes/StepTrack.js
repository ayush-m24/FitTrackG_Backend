...
router.post('/addstepentry', authTokenHandler, async (req, res) => {
    ...
    // Award badge if the user's steps exceed the step goal
    const stepGoal = user.goalSteps || 10000; // Default step goal if not set
    await awardBadge(userId, 'Steps', steps);
