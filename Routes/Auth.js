...
router.post('/login', async (req, res, next) => {
    try { //Take in the email and password
        ...
        res.cookie('authToken', authToken, { httpOnly: true, secure: false, sameSite: 'None', path: '/' });
        res.cookie('refreshToken', refreshToken, { httpOnly: true, secure: false, sameSite: 'None', path: '/'});
