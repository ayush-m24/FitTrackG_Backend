        ...
        if (err) {
            ...
            jwt.verify(refreshToken, process.env.REFRESH_TOKEN_SECRET, (refreshErr, refreshDecoded) => {
                if (refreshErr) {
                    ...
                    res.cookie('authToken', newAuthToken, { httpOnly: true, secure: true, sameSite: 'Lax', path: '/' });
                    res.cookie('refreshToken', newRefreshToken, { httpOnly: true, secure: true, sameSite: 'Lax', path: '/' });
